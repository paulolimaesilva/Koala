...
public class Testetabelacliente extends JFrame {
...
//		btExcluir.addActionListener(new BtExcluirListener());
	...
	public static void pesquisar(DefaultTableModel modelo) {
		...
		for (Cliente c : dao.getClientes()) {
			modelo.addRow(new Object[] { c.getIdCliente(), c.getNomeCliente(), c.getTelefoneCliente(), c.getEmailCliente() });
		}
	}
...
//	}
	...
	public static void main(String[] args) {
		Testetabelacliente lc = new Testetabelacliente();
		lc.setVisible(true);
	}
}
